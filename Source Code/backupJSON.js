...
suggest.controller('myData', function($scope, $http) {
    ...
    // suggest.filter('myFilter', function() {
    //     return function(items) {
    //         var filter = [];
    //         for (let i = 0; i < items.length; i++) {
    //             var item = items[i];
    //             if (item.id.contains("fg")) {
    //                 filter.push(item);
    //             }
    //         }
    //     }
    ...
    $scope.loadJson = function() { // dat su kien click
        ...
        if (result < 18.5) {
            ...
            document.getElementById('tuvan').innerHTML = 'ban gay wa'
        }
